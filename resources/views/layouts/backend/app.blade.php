...
<head>
    ...
    <meta name="description" content="Autpga Vanni autopesulad broneerimisüsteem.">
    <meta name="keywords" content="Online broneerimisüsteem, bookid broneerimissüsteem">
    <meta name="author" content="PIXINVENT">
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <title>Autoga Vanni autopesulad online broneerimisüsteem</title>
...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="">
    ...
    <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class="nav-item @php if($menu == 'locations') echo 'active' @endphp"><a class="d-flex align-items-center" href="{{ route('admin.locations') }}"><i data-feather='map-pin'></i><span class="menu-title text-truncate" data-i18n="Home">Pesulad</span></a>
                </li>
    ...
    <footer class="footer footer-static footer-light">
        <p class="clearfix mb-0"><span class="float-md-left d-block d-md-inline-block mt-25">COPYRIGHT &copy; 2021 <a class="ml-25" href="https://autogavanni.ee" target="_blank">Autoga Vanni autopesulad</a><span class="d-none d-sm-inline-block">, All rights Reserved</span></span></p>
    </footer>
